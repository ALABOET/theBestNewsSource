...
;
  ?></div>
    <ul class="nav-list">
        ...
        <li class="nav-item">
            <a href="hot.php" class="nav-link rrrapido">Самое актуальное</a>
        </li>
...
<?php
    $url = "https://newsapi.org/v2/top-headlines?country=ru&category=entertainment&apiKey=fb89237aea724504ae612adc1e824e37";
