...
;
  ?></div>
    <ul class="nav-list">
        ...
        <li class="nav-item">
            <a href="russia.php" class="nav-link rrrapido">Наука</a>
        </li>
...
<?php
    $url = "https://newsapi.org/v2/top-headlines?country=ru&category=science&apiKey=fb89237aea724504ae612adc1e824e37";
