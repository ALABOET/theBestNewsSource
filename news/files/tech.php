...
;
  ?></div>
    <ul class="nav-list">
        ...
        <li class="nav-item">
            <a href="tech.php" class="nav-link rrrapido">Новости Хайтека</a>
        </li>
    ...
    <?php
    $url = "https://newsapi.org/v2/top-headlines?country=ru&category=technology&apiKey=fb89237aea724504ae612adc1e824e37";
